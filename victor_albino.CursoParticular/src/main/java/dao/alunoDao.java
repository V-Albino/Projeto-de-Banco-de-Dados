...
public class alunoDao {
    ...
    public void inserirAluno(aluno a){
        try {
            String SQL="INSERT INTO victor_albino.aluno (nome, material, CPF, telefone)VALUES(?,?,?,?)";
    ...
    try {
        String SQL = "SELECT nome, material, CPF, telefone FROM  victor_albino.aluno ORDER BY nome";
    ...
    return null;
        ...
        public void atualizaDados(aluno dados) {
        try {
            ...
            c.close();
            if(retorno>0){
                JOptionPane.showMessageDialog(null,"Aluno "+dados.getNome()+ " atualizado com sucesso");
            }else{
                JOptionPane.showMessageDialog(null,"Erro ao atualizar o aluno: "+dados.getNome()+ ". Verifique os LOGs");
            }
        } catch (SQLException ex) {
            Logger.getLogger(alunoDao.class.getName()).log(Level.SEVERE, null, ex);
        }
