...
public class professorDao {
    public professorDao(){
     ...
     public void atualizaProfessor(professor a) {
        try {
            String SQL = " UPDATE victor_albino.professores set materia = ?, salario = ?, CPF = ?, nome = ?, material = ?, telefone = ?, email = ?";
            ...
            c.close();
            if(retorno>0){
                JOptionPane.showMessageDialog(null,"Professor "+a.getNome()+ " atualizado com sucesso");
            }else{
                JOptionPane.showMessageDialog(null,"Erro ao atualizar o professor: "+a.getNome()+ ". Verifique os LOGs");
            }
    ...
    public void inserirProfessor(professor a){
        try {
            String SQL="INSERT INTO victor_albino.professores (materia, salario, CPF, nome, material, telefone, email) VALUES (?,?,?,?,?,?,?)";
    ...
    public professor professorConsulta(professor filtro) {
            ...
            String SQL = "SELECT * FROM victor_albino.professor ORDER BY nome ";
            String FiltroWhere="";
            ...
            if(filtro!=null && filtro.getNome()!=null && !filtro.getNome().equalsIgnoreCase("")){
                ...
                FiltroWhere+=" nomer ilike '%"+filtro.getNome()+"%'";
            }
